...
sizeSlider = document.querySelector("#size-dropdown"),
...
document.addEventListener('DOMContentLoaded', function() {
    const toggleShapesButton = document.getElementById('toggleShapesButton');
    const shapeOptions = document.getElementById('shapeOptions');

    toggleShapesButton.addEventListener('click', function() {
